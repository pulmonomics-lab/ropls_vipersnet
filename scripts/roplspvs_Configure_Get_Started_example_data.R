...
## Project settings
projectname <- "testproj_MTBLS136" # "projectname" will appear in filenames and header of reports with underscores removed.
date_of_analysis <- 240430 # "yymmdd" numeric date of analysis will appear in filenames.
