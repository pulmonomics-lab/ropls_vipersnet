...
## Foldernames
foldername_Rmarkdownfiles <- "scripts" #"foldername". This is the folder for the scripts .R and .rmd files.
...
directory_input_matrix_sampleID <-  foldername_of_input_matrix_and_sampleID #may be altered to other than directory_of_analysis
directory_output_reports <- foldername_output_reports  #may be altered to other than directory_of_analysis
...
filename_elstic <- "roplspvs_Models_of_each_comparison_strategy6.Rmd"
...
## elastic net custom.grid preferences
alpha_val <- 0.5 # can be set from 0 to 1
lambda_min <- 0.0001
lambda_max <- 1
lambda_iter <- 1000
