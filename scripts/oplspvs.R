...
#' @param elastic whether or not to use elastic net (lasso/ridge) 
#' @param alpha_val parameter to set for custom.grid used for elastic
#' @param lambda_min parameters to set for custom.grid used for elastic
#' @param lambda_max parameters to set for custom.grid for elastic
#' @param lambda_iter parameters to set for custom.grid for elastic
#' @param filename_elstic file name for the glmnet elastic model
...
directory_Rmarkdownfiles <- foldername_Rmarkdownfiles # "path of directory/filename"
directory_function_file <- "scripts"
foldername_model_table_to_analyse <- foldername_output_reports #model_table_to_analyse will be saved in this folder.
directory_model_table_to_analyse <- paste(foldername_model_table_to_analyse,"/",sep="")
...
directory_output_reports <- paste("..",directory_output_reports,sep="/")
...
# make html file for elastic
if (elastic=="yes") {
  rmarkdown::render(paste(directory_Rmarkdownfiles,"/",filename_elstic, sep =""),
                    output_file = paste(directory_output_reports, "/Summary_elastic_net_",projectname, "_",date_of_analysis, sep=""),
                    params=list(
                      directory_output_reports=directory_output_reports,
                      directory_and_filename_function_file=directory_and_filename_function_file,
                      projectname=projectname,
